...
public class CreditsControllerTest {
    ...
    void testUpdateQuit() throws IOException {
        Credits model = mock(Credits.class);
        CreditsController controller = new CreditsController(model);
        ...
        // Mock the sprites used in MainMenuState constructor (via ViewerProvider)
